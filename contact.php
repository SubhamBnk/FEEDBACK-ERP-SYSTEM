...
?>
       ...
       <div class="row">
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    UEM JAIPUR, <br>Chomu, Jaipur, Rajasthan <br> India ,303807<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    7427972855</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <a href="subhamgourisariabnk@gmail.com">subhamgourisariabnk@gmail.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                     Monday - Sunday: 9:00 AM to 9:00 PM</p>
                <ul class="list-unstyled list-inline list-social-icons">
                    <li>
                        <a href="https://www.facebook.com/subham.gourisaria"><i class="fa fa-facebook-square fa-2x"></i></a>
                    </li>
                    <li>
                        <a href="https://www.linkedin.com/in/subham-gourisaria-a13418201/"><i class="fa fa-linkedin-square fa-2x"></i></a>
                    </li>
                    <li>
                        <a href="https://twitter.com/Subham_Coder"><i class="fa fa-twitter-square fa-2x"></i></a>
                    </li>
                </ul>
            </div>
        </div>
