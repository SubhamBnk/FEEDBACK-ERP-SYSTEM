...
<form method="post">
<fieldset>
<center><u><b><h2>STUDENT'S FEEDBACK FORM</u></center></b></h2>
...
<button type="button" style="font-size:9pt;color:white;background-color:green;border:2px solid #336600;padding:3px">Strongly Agree 5</button> &nbsp;
<button type="button" style="font-size:9pt;color:white;background-color:Brown;border:2px solid #336600;padding:3px">Agree 4</button> &nbsp;
<button type="button" style="font-size:9pt;color:white;background-color:blue;border:2px solid #336600;padding:3px">Neutral 3</button>&nbsp;
<button type="button" style="font-size:9pt;color:white;background-color:Black;border:2px solid #336600;padding:3px"> Disagree 2</button>&nbsp;
<button type="button" style="font-size:9pt;color:white;background-color:red;border:2px solid #336600;padding:3px">Strongly Disagree 1</button>&nbsp;<br>

<table class="table table-bordered" style="margin-top:50px">
<tr>

<th><h5><b>Select Faculty :</th></h5></b>
<td><b>
...
<h3>Class Teaching</h3>
 <table  class="table table-bordered" >
<Td><b>4.</b> Teacher is very dedicated & punctual, arrives on time and leaves on time: </td>
...
<tr>
<td><b>6.</b> Teacher is very good at explaining the subject matter with proper clarification and visualisation:</td>
<td>
...
<tr>
<td><b>12.</b> Exams & Assessments conducted are very much useful in maximizing the learning objectives:</td>
<Td>
...
<b>&nbsp; 14.</b> What I disliked about the course:<br><br>
<center>
